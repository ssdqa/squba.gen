...
color palettes used in data visualizations to the anomaly detection
methods that drive many computations. While these functions are intended
to be used within `squba` modules or applied to those results, they can
be used in other contexts when input data meets the appropriate
criteria.
