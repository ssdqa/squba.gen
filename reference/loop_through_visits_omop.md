...
- visit_type_tbl:
  ...
  - `visit_concept_id` / `visit_detail_concept_id`: the
    visit\_(detail)\_concept_id that represents the visit type of
...
- visit_tbl:
  ...
  the cdm visit_occurrence or visit_detail tbl
